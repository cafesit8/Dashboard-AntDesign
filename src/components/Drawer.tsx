...
const DrawerDefault = () => {
  ...
  return (
    <>
      <Drawer
        title={<div className='flex justify-between'><span>Dashboard</span><CloseIcon fn={handleOpen} /></div>}
        placement={'left'}
        closable={false}
        onClose={handleOpen}
        open={isOpen}
